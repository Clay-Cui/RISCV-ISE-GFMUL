...
GCC_FLAGS = {
    ...
    "gfmuls":           "-march=rv32ima    -mabi=ilp32",
    "gfmulv":           "-march=rv32ima    -mabi=ilp32",
}
...
class VexRiscv(CPU, AutoCSR):
    ...
    def add_soc_components(self, soc, soc_region_cls):
        ...
        if not base_variant in ["minimal", "lite","gfmulex_no_cache","gfmulex_csr","gfmulex_csr_aes","gfmulex_vector","gfmulexi","gfmulvex","csr","gfmuli","base","gfmuls","gfmulv"]:
            soc.add_config("CPU_HAS_DCACHE")
        # ICACHE is present on all variants except minimal.
        if not base_variant in ["minimal","gfmulex_no_cache","gfmulex_csr","gfmulex_csr_aes","gfmulex_vector","gfmulexi","gfmulvex","csr","gfmuli","base","gfmuls","gfmulv"]:
